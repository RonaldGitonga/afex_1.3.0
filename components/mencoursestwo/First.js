            ...
            <div className="row align-items-center class-scroll">
              <div className="col-lg-4 col-md-6 ">
                ...
                <div className="class-item mb-30">
                  ...
                  <div className="class-content">
                    <h4 className="title">
                      <Link href="/single-courses">Languge Class</Link>
                    </h4>
                    <p>
              ...
              <div className="col-lg-4 col-md-6 ">
                ...
                <div className="class-item mb-30">
                  ...
                  <div className="class-content">
                    <h4 className="title">
                      <Link href="/single-courses">Drawing Class</Link>
                    </h4>
                    <p>
                      Seamlessly visualize quality ellectual capital without superior
                      collaboration and idea.
              ...
              <div className="col-lg-4 col-md-6 ">
                ...
                <div className="class-item mb-30">
                  ...
                  <div className="class-content">
                    <h4 className="title">
                      <Link href="/single-courses">Mathematics Class</Link>
                    </h4>
                    <p>
                      Seamlessly visualize quality ellectual capital without superior
                      collaboration and idea.
              ...
              <div className="col-lg-4 col-md-6 ">
                ...
                <div className="class-item mb-30">
                  ...
                  <div className="class-content">
                    <h4 className="title">
                      <Link href="/single-courses">Web Design Class</Link>
                    </h4>
                    <p>
                      Seamlessly visualize quality ellectual capital without superior
                      collaboration and idea.
              ...
              <div className="col-lg-4 col-md-6 ">
                ...
                <div className="class-item mb-30">
                  ...
                  <div className="class-content">
                    <h4 className="title">
                      <Link href="/single-courses">HTMl Develpment Class</Link>
                    </h4>
                    <p>
                      Seamlessly visualize quality ellectual capital without superior
                      collaboration and idea.
              ...
              <div className="col-lg-4 col-md-6 ">
                ...
                <div className="class-item mb-30">
                  ...
                  <div className="class-content">
                    <h4 className="title">
                      <Link href="/single-courses">Digital Marketing Class</Link>
                    </h4>
                    <p>
                      Seamlessly visualize quality ellectual capital without superior
                      collaboration and idea.
