                    ...
                    <div className="col-lg-12">
                        <Slider className="testimonial-active wow fadeInUp animated" data-animation="fadeInUp" data-delay=".4s" {...settings}>
                            ...
                            <div className="single-testimonial text-center">
                                ...
                                <div className="testi-author">
                                    <Image width={80} height={80}src="https://utfs.io/f/4b0e4ce4-4fb1-4fe9-a979-5a63da66d888-lq2u9m.jpg" alt="img" className='rounded-circle' />
                                </div>
                                <div className="ta-info">
                                <h6>Whitney Njogu</h6>
                            ...
                            <div className="single-testimonial text-center">
                                ...
                                <div className="testi-author">
                                    <Image width={80} height={80}src="https://utfs.io/f/1a53565a-9867-4803-90a6-d2ac19ad5b76-vb3brz.jpg" alt="img" className='rounded-circle' />
                                </div>
                                <div className="ta-info">
